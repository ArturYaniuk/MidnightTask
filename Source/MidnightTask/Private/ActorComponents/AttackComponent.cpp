...
void UAttackComponent::SpawnProjectile(const USkeletalMeshSocket* BarrelSocket, USkeletalMeshComponent* GunMesh, UNiagaraSystem* MuzzleFlash, FVector Direction)
{
	...
	if (Projectile) Projectile->FireInDirection(Direction);
}
