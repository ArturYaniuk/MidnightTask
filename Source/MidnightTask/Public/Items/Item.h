...
UCLASS()
class MIDNIGHTTASK_API AItem : public AActor
{
	GENERATED_BODY()
...
public:
	...
	void PlayEquipSound(class AMidnightTaskCharacter* Char, bool bForcePlaySound = false);
...
private:
	...
	AMidnightTaskCharacter* Character;
